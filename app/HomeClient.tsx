...
export function StepCard({
  ...
  return (
    <motion.div
      ...
      className="rounded-card bg-white p-8 shadow-soft transition-shadow hover:shadow-soft-lg"
    >
...
export function CategoryCard({
  ...
  return (
    <motion.div
      ...
      whileHover={{ scale: 1.02, y: -4 }}
      className="rounded-card bg-white p-6 shadow-soft transition-shadow hover:shadow-soft-lg"
    >
    ...
    <div className="relative">
          ...
          <div className="flex flex-col items-center gap-12 lg:flex-row lg:gap-16">
            <div className="flex-1 text-center lg:text-left">
              ...
              <motion.p
                ...
                className="mt-6 max-w-xl text-lg text-slate-600 md:mx-0 mx-auto"
              >
                {t("home.heroSubtitle")}
              </motion.p>
              <motion.div
              ...
              >
                <Link href="/listings" className="inline-block">
                  <motion.span
                    className="inline-block rounded-button bg-primary px-6 py-3 text-base font-medium text-white shadow-soft hover:bg-blue-600 hover:shadow-soft-lg"
                ...
                <Link href="/add-listing" className="inline-block">
                  <motion.span
                    className="inline-block rounded-button border border-slate-300 bg-white px-6 py-3 text-base font-medium text-text hover:border-primary hover:text-primary"
                    whileHover={{ scale: 1.03 }}
                    whileTap={{ scale: 0.98 }}
                  >
                    {t("home.addYourSpace")}
        ...
        <div className="mx-auto max-w-7xl">
          ...
          {initialListings.length > 0 ? (
            ...
            <div className="mt-16 rounded-card bg-white p-12 text-center shadow-soft">
              <p className="text-slate-600">{t("home.noListings")}</p>
      ...
      <section className="relative bg-white/85 px-6 py-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-slate-600">{t("home.ctaSubtitle")}</p>
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <Link href="/add-listing" className="inline-block">
              <motion.span
                className="inline-block rounded-button bg-primary px-8 py-4 text-lg font-medium text-white shadow-soft hover:bg-blue-600 hover:shadow-soft-lg"
                whileHover={{ scale: 1.03 }}
                whileTap={{ scale: 0.98 }}
              >
                {t("home.addYourSpace")}
            ...
            <Link href="/listings" className="inline-block">
              <motion.span
                className="inline-block rounded-button border border-slate-300 bg-white px-8 py-4 text-lg font-medium text-text hover:border-primary hover:text-primary"
                whileHover={{ scale: 1.03 }}
                whileTap={{ scale: 0.98 }}
              >
                {t("home.browseSpaces")}
